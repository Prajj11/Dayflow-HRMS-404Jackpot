...
// SessionStore is satisfied by *SessionManager; tests can supply a fake.
type SessionStore interface {
	Create(ctx context.Context, userID int, role, userAgent string) (*Session, error)
	Authenticate(ctx context.Context, sessionID string) (*Session, error)
	Revoke(ctx context.Context, sessionID string) error
	RevokeAll(ctx context.Context, userID int) error
	List(ctx context.Context, userID int, currentID string) ([]SessionView, error)
}
